...
import ReportContentPremium from './ReportContentPremium';
...
export default async function ReportPremiumPage({ params }: PageProps) {
  ...
  if (!user) {
    ...
    redirect(`/signin/password_signin?redirect=/report-premium/${token}`);
  }
